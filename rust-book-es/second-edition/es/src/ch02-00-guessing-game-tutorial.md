...
recuperación de errores en el [Capítulo 9][cap9] <!-- ignore -->.
...
Debería obtener diferentes números aleatorios, y todos deberían ser números
...
El método [`parse` en *string*][parse] <!-- ignorar --> convierte un *string*
